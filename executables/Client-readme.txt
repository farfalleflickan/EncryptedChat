To execute EncryptedClientCLI.jar you must type "java -jar EncryptedClientCLI.jar" in a terminal window
or if you are using Microsoft Windows you can run the EncryptedClientCLI.bat file
